        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/clinic/dashboard" className="flex items-center space-x-3 group">
                <div >
                  <Image src="/logo.png" alt="Jigjiga University" width={40} height={40} className="rounded-lg" />
                </div>
                <div className="hidden sm:block">
                  <h1 className="text-xl font-bold text-gray-900 dark:text-white">Clinic Management System</h1>
